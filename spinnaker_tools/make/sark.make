...
spinnaker.gas: $(INC_DIR)/spinnaker.h
	$(TOOLS_DIR)/h2asm $(INC_DIR)/spinnaker.h | $(TOOLS_DIR)/arm2gas > spinnaker.gas

sark.gas: $(INC_DIR)/sark.h
	$(TOOLS_DIR)/h2asm $(INC_DIR)/sark.h | $(TOOLS_DIR)/arm2gas > sark.gas

sark_alib.gas: sark_alib.s
	$(TOOLS_DIR)/arm2gas sark_alib.s > sark_alib.gas
...
spinnaker.s: $(INC_DIR)/spinnaker.h
	$(TOOLS_DIR)/h2asm $(INC_DIR)/spinnaker.h > spinnaker.s

sark.s: $(INC_DIR)/sark.h
	$(TOOLS_DIR)/h2asm $(INC_DIR)/sark.h > sark.s
