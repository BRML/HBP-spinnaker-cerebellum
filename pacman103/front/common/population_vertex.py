...
class PopulationVertex( ComponentVertex , SynapticManager):
    ...
    def writeSetupInfo( self, spec, subvertex, spikeHistoryRegionSz,
        ...
        """
        # What recording commands were set for the parent population?
        recordingInfo = 0
    ...
    def get_ring_buffer_to_input_left_shift(self, subvertex):
        ...
        #DONE: implement part of changeset 4150, to incorporate plastic weights in max determination
        ...
        logger.debug("Max weight is {}, Max power is {}".format(max_weight, 
                max_weight_power))
#        print "max weight: ", max_weight,"log: ", max_weight_power
    ...
    def get_synaptic_data(self, controller, presubvertex, pre_n_atoms,
        ...
        '''
        return SynapticManager._get_synaptic_data(self, controller, presubvertex,
