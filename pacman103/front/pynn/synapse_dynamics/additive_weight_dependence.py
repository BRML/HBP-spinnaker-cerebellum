...
#        stdp_to_weight_scale = float(weight_scale) / 2048.0 #* (1<<16)
...
#        spec.write(data=int(round(self.A_plus * self.w_max * self.w_max * float(weight_scale))), sizeof="uint32")
        spec.write(data=int(round(self.A_plus * self.w_max * 2**15 )), sizeof="uint32")
        spec.write(data=int(round(self.A_minus * self.w_max * 2**20 )), sizeof="uint32")
