...
def deepest_parent( parents, child ):
    ...
    # Repeatedly strip elements off the child until we match an item in parents
    match = child
...
def level_of_deepest_parent( parents, child ):
    ...
    parent = deepest_parent( parents.keys(), child )
