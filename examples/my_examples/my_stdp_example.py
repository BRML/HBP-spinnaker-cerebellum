...
stdp_model = sim.STDPMechanism(
  timing_dependence = sim.SpikePairRule(tau_plus = 20., tau_minus = 20.0, nearest=True),
  weight_dependence = sim.AdditiveWeightDependence(w_min = 0.1, w_max = 1.0, A_plus=0.020, A_minus = 0.000)
)

plastic_projection = \
    sim.Projection(pre_pop, post_pop, sim.FixedProbabilityConnector(p_connect=0.1,weights=2.0),
