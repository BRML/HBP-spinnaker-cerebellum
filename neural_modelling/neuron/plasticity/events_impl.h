...
#define MAX_PRE_SYNAPTIC_EVENTS_BITS 7 //7
...
//  io_printf(IO_BUF,"\tInserting pre-synaptic event at location %u in queue\n", new_entry_index);
...
//  io_printf(IO_BUF,"\tNew start index:%u, new count:%u\n", event_history->start_index, event_history->count);
}
